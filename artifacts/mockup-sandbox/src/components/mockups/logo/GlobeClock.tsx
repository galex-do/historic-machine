      ...
      <g clipPath={`url(#g${size})`} fill={fg} fillOpacity="0.88" stroke="none">
        {(() => {
          ...
          return <>
            {/* Greenland */}
            <path d={poly([
              [-0.56,-0.76], [-0.38,-0.84], [-0.22,-0.82],
              [-0.18,-0.72], [-0.26,-0.62], [-0.44,-0.60],
              [-0.58,-0.64], [-0.62,-0.72],
            ])} />

            {/* North America */}
            <path d={poly([
              [-0.86,-0.50], [-0.72,-0.70], [-0.55,-0.80],
              [-0.38,-0.82], [-0.22,-0.78], [-0.14,-0.70],
              [-0.06,-0.68], [-0.08,-0.58], [-0.14,-0.50],
              [-0.18,-0.42], [-0.20,-0.30], [-0.20,-0.18],
              [-0.22,-0.06], [-0.26, 0.00], [-0.36, 0.04],
              [-0.44, 0.02], [-0.50,-0.06], [-0.54,-0.16],
              [-0.50,-0.28], [-0.44,-0.20], [-0.54,-0.06],
              [-0.62,-0.18], [-0.70,-0.30], [-0.78,-0.40],
              [-0.84,-0.48],
            ])} />

            {/* Central America bridge (connects NA to SA visually) */}
            <path d={poly([
              [-0.44, 0.02], [-0.36, 0.04], [-0.32, 0.08],
              [-0.30, 0.04], [-0.38,-0.02],
            ])} />

            {/* South America */}
            <path d={poly([
              [-0.30, 0.06], [-0.14, 0.00], [-0.06, 0.06],
              [-0.02, 0.16], [-0.02, 0.30], [-0.04, 0.44],
              [-0.10, 0.56], [-0.18, 0.66], [-0.26, 0.76],
              [-0.34, 0.76], [-0.40, 0.68], [-0.46, 0.54],
              [-0.50, 0.38], [-0.50, 0.24], [-0.46, 0.10],
              [-0.40, 0.04],
            ])} />

            {/* Europe (Iberian + France, partially clipped by clock sector) */}
            <path d={poly([
              [-0.20,-0.56], [-0.08,-0.62], [ 0.00,-0.60],
              [ 0.04,-0.50], [ 0.00,-0.40], [-0.06,-0.36],
              [-0.14,-0.40], [-0.18,-0.50],
            ])} />

            {/* Africa (western + southern — NE clipped by clock sector naturally) */}
            <path d={poly([
              [-0.08,-0.28], [ 0.08,-0.30], [ 0.20,-0.24],
              [ 0.30,-0.10], [ 0.36, 0.06], [ 0.34, 0.22],
              [ 0.28, 0.40], [ 0.20, 0.54], [ 0.08, 0.62],
              [-0.06, 0.64], [-0.18, 0.56], [-0.28, 0.42],
              [-0.32, 0.26], [-0.26, 0.10], [-0.24, 0.02],
              [-0.28,-0.08], [-0.22,-0.20], [-0.12,-0.26],
            ])} />
          </>
        })()}
      </g>
