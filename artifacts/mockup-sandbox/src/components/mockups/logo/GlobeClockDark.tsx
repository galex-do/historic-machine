    ...
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
      ...
      <g clipPath={`url(#gd${size})`} fill="none" stroke="#22d3ee" strokeWidth={s * 1.8}
         filter={`url(#glow${size})`} strokeLinejoin="round">
                ...
                <path d={poly([[0.218,-0.242],[0.578,-0.53],[0.759,-0.375],[0.828,0.407],[0.718,0.5],[0.628,0.574],[0.616,0.559],[0.644,0.375],[0.646,0.259],[0.668,0.035],[0.543,-0.087],[0.272,-0.174]])} />
