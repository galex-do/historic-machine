    ...
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none">
      ...
      <g clipPath={`url(#gd${size})`} fill="none" stroke="#22d3ee" strokeWidth={s * 1.8}
         filter={`url(#glow${size})`} strokeLinejoin="round">
                        <path d={poly([[-0.50,-0.74],[-0.32,-0.84],[-0.18,-0.82],[-0.14,-0.70],[-0.24,-0.62],[-0.42,-0.60],[-0.56,-0.66]])} />
                <path d={poly([[-0.88,-0.46],[-0.72,-0.66],[-0.52,-0.80],[-0.34,-0.86],[-0.18,-0.82],[-0.06,-0.72],[-0.12,-0.58],[-0.16,-0.44],[-0.18,-0.30],[-0.20,-0.16],[-0.22,-0.02],[-0.27,0.06],[-0.38,0.08],[-0.48,0.06],[-0.56,-0.04],[-0.62,-0.18],[-0.68,-0.28],[-0.76,-0.38],[-0.84,-0.44]])} />
                <path d={poly([[-0.38,0.10],[-0.20,0.04],[-0.10,0.08],[0.00,0.14],[0.08,0.30],[0.06,0.48],[-0.02,0.58],[-0.12,0.66],[-0.22,0.72],[-0.30,0.78],[-0.36,0.82],[-0.42,0.76],[-0.48,0.62],[-0.52,0.46],[-0.50,0.28],[-0.44,0.10]])} />
                <path d={poly([[0.14,-0.28],[0.28,-0.16],[0.38,-0.02],[0.42,0.14],[0.36,0.32],[0.28,0.48],[0.18,0.62],[0.06,0.70],[-0.06,0.70],[0.12,0.58],[0.14,0.44],[0.16,0.28],[0.18,0.12],[0.16,-0.04],[0.14,-0.18]])} />
